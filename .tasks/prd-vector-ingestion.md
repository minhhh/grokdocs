...
- [ ] **us-xx**: Hierarchical chunking — max parent size 2000 chars, split into overlapping sub-chunks of ~400 chars (10% overlap), embed sub-chunks for FAISS, search on sub-chunks, roll up by max score to parent
